...
function notice(
  ...
  const iconTypes: { [key: string]: string | Function | React.ReactNode } = {
    info: '',
    success: 'success',
    fail: 'fail',
    offline: 'dislike',
...
export default {
  SHORT,
  LONG: 8,
  mineUI(type: 'otherNet' | 'guide', props: { [key: string]: any }) {
    return show(Nodes[type], props);
  },
